...
- **rules/analyzers** apply the heuristics shipped in `accessreview/core.py`.
- **score** ranks by severity.
- **MCP server** (`accessreview mcp`) exposes `scan` for Cognis.Studio agents.
