"""ACCESSREVIEW core — Periodic user-access-review (UAR) campaign runner."""
...
RULES = [
    ("ACC-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("ACC-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("ACC-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
