#!/usr/bin/env sh
# Universal installer for accessreview. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/accessreview.git"
echo "Installing accessreview ..."
...
echo "Done. Run: accessreview --help"
