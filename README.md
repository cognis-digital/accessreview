...
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:6b46c1,100:2b6cb0&height=120&section=header&text=ACCESSREVIEW&fontSize=48&fontColor=ffffff&fontAlignY=58" width="100%" alt="ACCESSREVIEW"/>

# ACCESSREVIEW

### Periodic user-access-review (UAR) campaign runner

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&duration=3500&pause=1000&color=6B46C1&center=true&vCenter=true&width=720&lines=Periodic+useraccessreview+UAR+campaign+runner;Self-hostable+%C2%B7+MCP-native+%C2%B7+CI-ready+%C2%B7+polyglot" width="720"/>

[![PyPI](https://img.shields.io/pypi/v/cognis-accessreview.svg?color=6b46c1)](https://pypi.org/project/cognis-accessreview/) [![CI](https://github.com/cognis-digital/accessreview/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/accessreview/actions) [![License: COCL 1.0](https://img.shields.io/badge/License-COCL%201.0-2b6cb0.svg)](LICENSE) [![Suite](https://img.shields.io/badge/Cognis-Neural%20Suite-6b46c1.svg)](https://github.com/cognis-digital)
...
- [Why accessreview?](#why) · [Features](#features) · [Quick start](#quick-start) · [Example](#example) · [How it compares](#how-it-compares) · [Integrations](#integrations) · [Install anywhere](#install-anywhere) · [Related](#related) · [Contributing](#contributing)
...
accessreview scan . --fail-on high        # CI gate (non-zero exit)
```
...
```text
$ accessreview scan .
  [HIGH    ] ACC-001  example finding             (./src/app.py)
  [MEDIUM  ] ACC-002  another signal              (./config.yaml)
...
Pipes into your stack: **SARIF** for code-scanning, **JSON** for anything, an **MCP server** (`accessreview mcp`) for AI agents, and a webhook forwarder for SIEM/Slack/Jira. See [`docs/INTEGRATIONS.md`](docs/INTEGRATIONS.md).
...
|---|---|---|---|---|
| `scripts/setup-linux.sh` | `scripts/setup-macos.sh` | `scripts/setup-windows.ps1` | `docker run ghcr.io/cognis-digital/accessreview` | [DEPLOY.md](docs/DEPLOY.md) (AWS/Azure/GCP/k8s) |
