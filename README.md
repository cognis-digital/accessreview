...
[![PyPI](https://img.shields.io/pypi/v/cognis-accessreview.svg)](https://pypi.org/project/cognis-accessreview/)
[![CI](https://github.com/cognis-digital/accessreview/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/accessreview/actions)
...
ACCESSREVIEW exists for one job — periodic user-access-review (uar) campaign runner — and does it without a SaaS bill or heavyweight setup.
...
accessreview scan .                      # scan the current project
accessreview scan . --format json
accessreview scan . --fail-on high       # non-zero exit for CI gates
accessreview mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **access review**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`accessreview` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
